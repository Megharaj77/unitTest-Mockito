...
public class TreeSetTest {
	...
	public void initializeMocks() {
		...
		//NOTE: The initMocks() method is deprecated, and openMocks() is preferred instead 
		//initMocks() causes misbheaviour of mocks- injected into the test class under certain
		//conditions
