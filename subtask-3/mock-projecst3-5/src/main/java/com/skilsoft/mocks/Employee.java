...
public class Employee {
	...
	public boolean saveToDatabase(String connectionString) {
		...
		//NOTE: Assume that this method connects to a database and store the details of this employee
	...
	public boolean deleteFromDatabase(String connectionString) {
		...
		//NOTE: Assume that this method connects to a database and delete the details of this employee
